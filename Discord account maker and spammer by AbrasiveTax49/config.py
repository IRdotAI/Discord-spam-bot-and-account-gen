...
userToken = ['YourTokenHere'] # User Tokens here. example 'token','token' | 'email:pass', 'token'
DiscordChannel = 'LastNumbersBeforeTheSlash' # Channel ID,
...
#DM Spam
DiscordServer = 'LastNumbersBeforeTheSlash' # Server ID (https://i.imgur.com/m06TSEx.png this one)
...
#Picture spam
DirPictures = 'C:\\Users\\AbrasiveTax49\\Pictures\\spam\\' # Picture(s) location, end directory with a double slash.
